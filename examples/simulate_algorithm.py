...
# #
# This script is used to simulate the paper "Single-ancilla ground state preparation via Lindbladians" (doi: 10.1103/PhysRevResearch.6.033147)
# Note that, in this script, the dilation operator K̃ is generated directly from the Equation (2), rather than its optimal implementation using more elementary gates.
# The implementation with the simplified version can be found it tfim4.py and lindblad.py
